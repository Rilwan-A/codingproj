...
--start_prop_test "0.8" --end_prop_test "1.0" --num_steps "50" --s4_lmax "22" --layers "2" \
 --channels "64" --featureemb "64" --timeemb "16"  --diffusion_embedding_dim "128"   --learning_rate "5e-4" \
 --weight_decay "1e-6"
...
--batch_size_val "8" --num_res_layers "18" --in_channels "380" --out_channels "380" \
